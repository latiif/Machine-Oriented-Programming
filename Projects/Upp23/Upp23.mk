...
ProjectPath            :=C:/Users/shriaf/Documents/Labb2/Upp23
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/Upp23.elf ./Debug/Upp23.s19
	arm-none-eabi-objdump -D -S ./Debug/Upp23.elf > ./Debug/Upp23.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/shriaf/Documents/Labb2/Upp23/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
